...
/**
 * 
 * @param {id or class where the Radar Chart is to be placed} id 
 * @param {2D array of data to be displayed} data 
 * @param {only overrides are required} options 
 * 
 * Inspired by the work done by: Nadieh Bremer (Who was also inspired)
...
function radarChart(id, data, options) {
	...
	// If the supplied maxValue is smaller than the config maxValue, replace by the max in the data
